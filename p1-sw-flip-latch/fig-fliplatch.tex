...
% Labels are sloped: the sel=0 arrow rises about 27 degrees, and a horizontal
% label placed "above" its midpoint is crossed by the arrow's own line.
\draw[arr, gray!70!black] (sel.east) -- node[above, sloped, font=\scriptsize, pos=0.5] {\code{sel}=0} (o1.west);
\draw[arr, thick] (sel.east) -- node[below, sloped, font=\scriptsize, pos=0.5] {\code{sel}=1} (n1.west);
