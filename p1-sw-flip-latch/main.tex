...
writers, who are by hypothesis the minority.\footnote{The sentiment is neither
ours nor confined to this subject. \citet{alglave2013weakness} makes it of weak
memory models: a weakness usually treated as an obstacle to verification is
better embraced than repaired, since a model that needs no total order admits
cheaper analysis than sequential consistency does. Different domain, and
evidence for nothing here, but the same shape of argument.}
...
remains in force. The generation-number family is treated as a technical answer
in \cref{sec:relrcu}; four others bound what this paper may claim, and are taken
in turn here.
