...
stating plainly because the same harness reports them. A reader-writer lock and a
seqlock traversing the same list land within a few percent of plain \rcu, and at
192 readers the seqlock is the fastest of the four. That is not a finding about
locks. It is what happens when a 10\,000-node traversal amortizes one acquisition
to nothing, and it is why the honest read-side comparison in
