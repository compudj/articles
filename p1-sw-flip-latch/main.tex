...
single-slot reads, each linearizing at its own access. There is no bracket, no
read set, and nothing that begins or commits on the read side --- the \pseudotxn
is the writer's object, and a reader meets it only one slot at a time. A
