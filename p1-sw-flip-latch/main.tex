...
region as one of \rcu's remedies for an update that spans several words. There
is a way to give readers a snapshot for nothing, and \rcu uses it: copy. A writer that builds a new version where
