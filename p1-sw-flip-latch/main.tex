...
for a traversal of any shape --- including one that goes around a cycle, where
there is no fixed order to publish against and ordering tricks have nothing to
work with (\cref{sec:publishorder}).
