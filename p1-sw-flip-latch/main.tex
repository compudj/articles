...
work on the reader's path. This engine pays in neither. \Cref{sec:costcomparison}
...
comparison against RLU crosses them (\cref{sec:relrcu}).
...
to \rcu must charge the reader something, and that this engine charges the
