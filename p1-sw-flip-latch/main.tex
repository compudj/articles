...
slots --- two separate structures, or two sibling subtrees of one, as a
depth-first walk without parent pointers reaches them --- has no such edge: under \code{-DURCU\_DEREFERENCE\_USE\_VOLATILE} on
