...
\usepackage{cleveref}
% cleveref abbreviates figures ("fig. 6") but spells out every other class
% this series references -- section, table, property, definition. Spell
% figures out too, so a cross-reference reads the same wherever it points.
