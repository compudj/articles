...
% The two transitions are NOT listed here.  sec:status draws them properly a page
% earlier -- one state, two exits -- and repeating them as a text list under this
% arrow was three lines saying what that diagram says better.  What remains is the
% property the arrow is here for: the write happens once and is terminal.
\draw[-latex, very thick, orange!70!black] (st.south) -- ++(0,-0.8)
