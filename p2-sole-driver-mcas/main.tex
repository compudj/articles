...
sole-driver facility needs \textbf{no RDCSS}, and that the facility as a
...
which facility it links, not how it reasons about a commit.
...
a factor of roughly $2.6$.\footnote{Measured on the facility's own
...
\bottomrule
\end{tabular}
\caption{The measured design space around the sole-driver facility. Each row was
...
reader pointer. We disclose that as the reason the technique fits this facility, and
...
instructive about the whole difference between the two facilities.
...
\item[\code{rcu-txn-mcas.h}] The sole-driver \mcas engine: records, the tri-state
      ...
      (\cref{sec:facility,sec:norddcss,sec:settle}). At the pinned commit this
