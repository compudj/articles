...
frozen node for free without consulting the tombstone at all, which keeps it off
the reader's path and on a cold cache line. This is a known
...
largely duplicated effort the owner would complete anyway. That diagnosis is not
