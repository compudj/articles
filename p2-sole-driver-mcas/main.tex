...
The paper claims two things, developed below and drawn together in
\cref{sec:relclaims}: a specific negative result---that a sole-driver engine needs
no RDCSS---and, more broadly, the engine as a combination of otherwise-known parts
we have not found assembled before, of which that result is the linchpin. The
contributions that build them are:
